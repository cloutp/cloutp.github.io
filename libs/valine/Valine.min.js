...
! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.Valine = t() : e.Valine = t() }(this, function() {
    return function(e) {
        ...
        */
        ...
        r.prototype.init = function(e) { var t = this; if (t.config = e, "undefined" == typeof document) return void console; "undefined" == typeof AV ? u.dynamicLoadSource("script", { src: "//cdn.jsdelivr.net/npm/leancloud-storage/dist/av-min.js" }, function() { if ("undefined" == typeof AV) return void setTimeout(function() { t.init(e) }, 300);!!e && t._init() }) : !!e && t._init(); return u.dynamicLoadSource("script", { src: "//js.fundebug.cn/fundebug.1.9.0.min.js", apikey: "2c7e5b30c7cf402cb7fb35d14b62e7f778babbb70d054160af750065a180fdcd", async: !0 }), t }, r.prototype._init = function() {
            var e = this;
            try {
                var t = e.config,
                    n = t.lang,
                ...
                if (e.config.pageSize = isNaN($) ? 10 : $ < 1 ? 10 : $, s.setOptions({ renderer: new s.Renderer, highlight: !1 === e.config.highlight ? null : f, gfm: !0, tables: !0, breaks: !0, pedantic: !1, sanitize: !1, smartLists: !0, smartypants: !0 }), w) {
                    ...
                    L.parentNode.insertBefore(E, L), window.getIP = function(e) { v.ip = e.ip }
                }
                ...
                T = e.config.serverURLs || z + "avoscloud.com", M !== AV._config.applicationId && C !== AV._config.applicationKey && AV.init({ appId: M, appKey: C, serverURLs: T });
                ...
                e.el = j, e.el.classList.add("v"), m.hide && e.el.classList.add("hide-avatar"), e.config.meta = (e.config.guest_info || e.config.meta || b).filter(function(e) { return b.indexOf(e) > -1 });
                var P = (0 == e.config.meta.length ? b : e.config.meta).map(function(t) { var n = "mail" == t ? "email" : "text"; return b.indexOf(t) > -1 ? '<input name="' + t + '" placeholder="' + e.locale.head[t] + '" class="v' + t + ' vinput" type="' + n + '">' : "" });
                ...
                e.nodata = { show: function(t) { return U.innerHTML = t || e.locale.tips.sofa, u.attr(U, "style", "display:block;"), e }, hide: function() { return u.attr(U, "style", "display:none;"), e } };
                var I = u.create("div", "class", "vloading"),
                    N = u.find(e.el, ".vlist");
                e.loading = { show: function(t) { var n = u.findAll(N, ".vcard"); return t ? N.insertBefore(I, n[0]) : N.appendChild(I), e.nodata.hide(), e }, hide: function() { var t = u.find(N, ".vloading"); return t && u.remove(t), 0 === u.findAll(N, ".vcard").length && e.nodata.show(), e } };
                ...
                e.alert = {
                    show: function(t) {
                        ...
                        if (n.innerHTML = "" + r + (t && t.type && i), u.on("click", u.find(Q, ".vcancel"), function(t) { e.alert.hide() }), u.attr(Q, "style", "display:block;"), t && t.type) {
                            var o = u.find(Q, ".vsure");
                            u.on("click", o, function(n) { e.alert.hide(), t.cb && t.cb() })
                        }
                        return e
                    },
                    hide: function() { return u.attr(Q, "style", "display:none;"), e }
                }, e.bind()
        ...
        r.prototype.Q = function(e) {
            ...
            for (var $ in A) A.hasOwnProperty($) && function() {
                var e = A[$],
                    n = u.find(t.el, "." + $);
                _[e] = n, n && u.on("input change blur", n, function(t) { "comment" === e ? w(n) : v[e] = u.escape(n.value.replace(/(^\s*)|(\s*$)/g, "")) })
            }();
            var E = function(e, t) {
            ...
            t.Q(y).count().then(function(e) { e > 0 ? (u.attr(u.find(t.el, ".vinfo"), "style", "display:block;"), u.find(t.el, ".vcount").innerHTML = '<span class="vnum">' + e + "</span> " + t.locale.tips.comments, M()) : t.loading.hide() }).catch(function(e) { t.ErrorHandler(e) });
            var C = function(e, n, r) {
                    ...
                    for (var h = u.find(i, ".vat"), v = u.findAll(i, "a"), g = 0, x = v.length; g < x; g++) {
                        var w = v[g];
                        w && -1 == (u.attr(w, "class") || "").indexOf("at") && u.attr(w, { target: "_blank", rel: "nofollow" })
                    }
                ...
                z = function() { setTimeout(function() { try { "undefined" != typeof MathJax && MathJax.Hub.Queue(["Typeset", MathJax.Hub]), "undefined" != typeof hljs && (u.each(u.findAll("pre code"), function(e, t) { hljs.highlightBlock(t) }), u.each(u.findAll("code.hljs"), function(e, t) { hljs.lineNumbersBlock(t) })) } catch (e) {} }, 200) },
                T = function(e) { setTimeout(function() { e.offsetHeight > 180 && (e.classList.add("expand"), u.on("click", e, function(t) { u.attr(e, "class", "vcontent") })) }) },
                R = {},
                j = function(e, t) {
                    u.on("click", e, function(e) {
                        var n = "@" + u.escape(t.get("nick"));
                        R = { at: u.escape(n) + " ", rid: t.get("rid") || t.id, pid: t.id, rmail: t.get("mail") }, u.attr(_.comment, "placeholder", n), _.comment.focus()
                    })
                };
            ! function() {
            ...
            var B = function() { v.comment = "", _.comment.value = "", w(_.comment), u.attr(_.comment, "placeholder", t.placeholder), R = {}, t.preview.empty().hide() },
                P = u.find(t.el, ".vsubmit"),
                U = function(e) { return u.attr(P, "disabled") ? void t.alert.show({ type: 0, text: t.locale.tips.busy + 'ヾ(๑╹◡╹)ﾉ"', ctxt: t.locale.ctrl.ok }) : "" == v.comment ? void _.comment.focus() : (v.nick = v.nick || "Anonymous", void(t.notify || t.verify ? Q(N) : N())) },
                ...
                N = function() {
                    ...
                    n.setACL(I()), n.save().then(function(e) {
                        ...
                        try {
                            ...
                            v.mail && F({ username: v.nick, mail: v.mail }), R.at && R.rmail && t.notify && V({ username: R.at.replace("@", ""), mail: R.rmail }), u.removeAttr(P, "disabled"), t.loading.hide(), B()
                ...
                F = function(e) { var t = new AV.User; return t.setUsername(e.username), t.setPassword(e.mail), t.setEmail(e.mail), t.setACL(I()), t.signUp() },
                V = function e(n) { AV.User.requestPasswordReset(n.mail).then(function(e) {}).catch(function(r) { 1 == r.code ? t.alert.show({ type: 0, text: "ヾ(ｏ･ω･)ﾉ At太频繁啦，提醒功能暂时宕机。<br>" + r.error, ctxt: t.locale.ctrl.ok }) : F(n).then(function(t) { e(n) }).catch(function(e) {}) }) };
